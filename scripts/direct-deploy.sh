...
# Extremely simplified deployment script for MorSaaS
echo "===== MorSaaS Direct Deployment ====="
...
# Build Docker image specifically for AMD64
...
# Deploy directly to Cloud Run using the Docker image
